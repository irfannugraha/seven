    ...
    <div class="register" style="background-image: url(&quot;<?php echo base_url()?>assets/img/background%20page%20vendor.png&quot;);background-position: center;background-size: contain;background-repeat: no-repeat;">
        ...
        <div class="form-container">
            <form method="post" action="<?php echo base_url(). 'c_registerVendor/tambahAkun/' .$id_vendor. '/' .$id_pelanggan; ?>">
                <h1>Daftar Vendor</h1>
                <div class="form-group"><label class="form-label">Nama Vendor</label><input class="form-control name" type="text" placeholder="Nama anda" name="nama" maxlength="20" required>
                    <div>
                ...
                <div class="form-group"><label class="form-label">No Telepon</label><input class="form-control" type="number" name="telepon" placeholder="Nomor anda" required></div>
